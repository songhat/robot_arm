...
PKG_CONFIG_LIBRARIES_WITH_PREFIX = "-lfranka_ros_controllers;/opt/ros/noetic/lib/x86_64-linux-gnu/libfranka.so.0.9.2".split(';') if "-lfranka_ros_controllers;/opt/ros/noetic/lib/x86_64-linux-gnu/libfranka.so.0.9.2" != "" else []
